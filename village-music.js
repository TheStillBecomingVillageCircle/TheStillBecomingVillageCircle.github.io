...
(function () {
    ...
    async function navigate(url, push) {
        ...
        const incoming = [...parsed.body.children].filter(child => child.id !== PLAYER_ID && child.id !== 'soundtrack' && child.id !== 'musicBubble' && !child.classList.contains('soundtrack') && !child.classList.contains('music-bubble'));

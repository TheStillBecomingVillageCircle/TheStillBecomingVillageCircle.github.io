...
const NAV_PAGES=new Set(['index.html','about.html','LearningtheUnknown.html','experiences.html','events.html','contact.html','coaching.html','kitta.html','web-design.html']);
...
function styles(){if(document.getElementById('village-music-styles'))return;const s=document.createElement('style');s.id='village-music-styles';s.textContent=`#${PLAYER_ID}{position:fixed;right:18px;bottom:18px;width:112px;height:112px;z-index:99999;background:transparent;border:0;display:flex;align-items:center;justify-content:center;cursor:pointer}#${PLAYER_ID} .closed{position:relative;width:112px;height:112px;display:flex;align-items:center;justify-content:center}#${PLAYER_ID} .music-orb{width:110px;height:110px;display:flex;align-items:center;justify-content:center}#${PLAYER_ID} .sax{position:relative;width:110px;height:110px;display:flex;align-items:center;justify-content:center;filter:drop-shadow(0 6px 10px rgba(40,120,120,.1))}.sax-bubble{width:110px;height:110px;display:block;overflow:visible}.sax-bubble .cover{opacity:.54}.sax-bubble .glass{fill:rgba(218,255,251,.18);stroke:rgba(255,255,255,.94);stroke-width:1.5}.sax-bubble .tube{fill:none;stroke:rgba(255,255,255,.88);stroke-width:2.1;stroke-linecap:round;stroke-linejoin:round}.sax-bubble .shine{fill:none;stroke:rgba(255,255,255,.92);stroke-width:1.8;stroke-linecap:round}.sax-bubble .key{fill:rgba(255,255,255,.58);stroke:rgba(70,140,140,.18);stroke-width:1}.sax-bubble .bubble-highlight{fill:rgba(255,255,255,.2);stroke:rgba(255,255,255,.7);stroke-width:1}#${PLAYER_ID} .play{position:absolute;left:62%;top:72%;transform:translate(-50%,-50%);width:25px;height:25px;border:1px solid rgba(255,255,255,.78);border-radius:50%;background:rgba(220,255,251,.22);color:#fff;display:flex;align-items:center;justify-content:center;font:12px Arial,sans-serif}#${PLAYER_ID}.playing .play{font-size:0}#${PLAYER_ID}.playing .play:after{content:'❚❚';font-size:9px}#${PLAYER_ID} .content{position:absolute;left:-9999px;top:-9999px;width:1px;height:1px;opacity:0;pointer-events:none}#${PLAYER_ID}.open .content{position:fixed;right:20px;bottom:20px;left:auto;top:auto;width:min(390px,calc(100vw - 40px));height:auto;opacity:1;pointer-events:auto;background:rgba(235,255,252,.94);border:1px solid rgba(255,255,255,.85);border-radius:24px;padding:16px;box-shadow:0 18px 45px rgba(40,120,120,.18);backdrop-filter:blur(10px)}#${PLAYER_ID} .cover-open{display:block;width:150px;height:150px;object-fit:cover;border-radius:18px;margin:0 auto 10px}#${PLAYER_ID} .title{text-align:center;color:#285f61;font:700 17px Arial,sans-serif}#${PLAYER_ID} .song{text-align:center;color:#16aaa9;font:14px Arial,sans-serif;margin:3px 0 10px}#${PLAYER_ID} iframe{width:100%;height:166px;border:0;border-radius:16px}#${PLAYER_ID} .close{display:block;margin:9px auto 0;border:0;background:#fff;color:#285f61;padding:7px 20px;border-radius:25px;font-weight:700}@media(max-width:600px){#${PLAYER_ID}{width:94px;height:94px;right:5px;bottom:8px}#${PLAYER_ID} .closed,#${PLAYER_ID} .music-orb,#${PLAYER_ID} .sax,.sax-bubble{width:92px;height:92px}#${PLAYER_ID} .play{width:23px;height:23px}}`;

...
(function () {
    ...
    function addStyles() {
        ...
        style.textContent = `
            ...
            #${PLAYER_ID} .sax{font-size:48px;line-height:1;filter:drop-shadow(0 3px 5px rgba(40,95,97,.14));transform:translateY(-2px)}

const CACHE = "still-becoming-village-v2";
const APP_SHELL = ["/village-app.html", "/", "/index.html", "/village-app.webmanifest", "/village-icon.svg"];
...
async function upgradeHtml(response) {
  ...
  return new Response(upgraded, {status: response.status, statusText: response.statusText, headers: response.headers});
}

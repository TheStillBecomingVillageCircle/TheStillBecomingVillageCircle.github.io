...
/* The only six navigation destinations and the exact icon files requested. */
const ITEMS=[
...
/* Old navigation systems and the unwanted gold ornament are disabled. */

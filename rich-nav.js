/* Site-wide illustrated navigation. The Home item uses the exact approved Home artwork. */
(function(){
'use strict';
function apply(){
 ...
 items.forEach((it,i)=>{
  ...
  if(i===0){
   ...
   img.src='/assets/home-button-exact.jpg?v=20260827';
   img.alt='Home';
   img.loading='eager';
   art.appendChild(img);
  }
